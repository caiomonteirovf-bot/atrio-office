...
INSERT INTO team_members (name, type, role, department, status, contact) VALUES
    ('Deyvison', 'human', 'Coordenador operacional', 'operacional', 'available', '{"whatsapp": "", "email": ""}'::jsonb),
    ('Diego', 'human', 'Assistente contábil', 'operacional', 'available', '{"whatsapp": "", "email": ""}'::jsonb);
